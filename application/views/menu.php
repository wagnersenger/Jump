...
<ul class="fD menu">
	<li><a href="<?php echo base_url('orcamento/solicitacao/cadastrar'); ?>">Solicitação de Layout/Orçamento</a></li>
	...
	<?php if($this->session->userdata('user_categoria_id') == 1){ ?>
		...
		<li><a href="<?php echo base_url('produto/lista'); ?>">Cadastro de Produto Padrão</a></li>
